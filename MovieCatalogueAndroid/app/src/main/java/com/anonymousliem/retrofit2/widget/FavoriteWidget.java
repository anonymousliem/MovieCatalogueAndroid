...
public class FavoriteWidget extends AppWidgetProvider {
    public static final String EXTRA_ITEM = "com.anonyousliem.retrofit2.EXTRA_ITEM";
    private static final String TOAST_ACTION = "com.anonyousliem.retrofit2.TOAST_ACTION";
    ...
    public void onReceive(Context context, Intent i) {
        if (i.getAction().equals(TOAST_ACTION)) {
            ...
            Toast.makeText(context, "layer yg dipilih " + viewIndex, Toast.LENGTH_SHORT).show();
        }
